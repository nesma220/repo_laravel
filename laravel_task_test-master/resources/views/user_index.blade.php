...
<head>
   ...
   <title>Kindedo - Home</title>
   <meta name="description" content="">
   <meta name="viewport" content="width=device-width, initial-scale=1">

   <!-- Place favicon.ico in the root directory -->
   <link rel="shortcut icon" type="image/x-icon" href="assetss/img/logo/favicon.png">
   ...
   <link rel="stylesheet" href="assetss/css/swiper-bundle.css">
   <link rel="stylesheet" href="assetss/css/slick.css">
   <link rel="stylesheet" href="assetss/css/nouislider.css">
   <link rel="stylesheet" href="assetss/css/backtotop.css">
   <link rel="stylesheet" href="assetss/css/magnific-popup.css">
   <link rel="stylesheet" href="assetss/css/nice-select.css">
   <link rel="stylesheet" href="assetss/css/flaticon_kindedo.css">
   <link rel="stylesheet" href="assetss/css/font-awesome-pro.css">
   <link rel="stylesheet" href="assetss/css/spacing.css">
...
<body>
      ...
      <div id="preloader">
         <div class="preloader-thumb-wrap">
            <div class="preloader-thumb">
               ...
               <img src="assetss/img/bg/preloader.png" alt="img not found!">
            </div>
         </div>
      </div>
   </div>
               ...
               <div class="mega-menu-wrapper p-relative">
                  <div class="d-flex align-items-center justify-content-between">
                     <div class="bd-header-logo">
                        <a href="index.html">
                           <img src="assetss/img/logo/logo.svg" alt="logo">
                        </a>
                     </div>
                                       ...
                                       <ul>
                                          <li>
                                             <div class="mega-menu-2-inner-thumb p-relative">
                                                <img src="assetss/img/logo/mega-menu-1.png" alt="img not found!">
                     ...
                     <div class="bd-header-bottom-right d-flex justify-content-end align-items-center">
                                          ...
                                          <li>
                                             <div class="bd-header-cart-content">
                                                <div class="bd-header-cart-thumb">
                                                   <a href="shop-details.html"> <img src="assetss/img/shop/9.2.jpg"
                                                         alt="img not found!"></a>
                                                </div>
                        ...
                        <div class="bd-header-btn d-none d-xl-block">
                            @if (!Auth::user())
                            <li class="bd-header-btn d-none d-xl-block">
                                <a href="{{ route('register') }}" class="bd-btn" style="margin-top: 10px;">مستخدم جديد</a>
                            </li>
                        @endif
                        </ul>
                            ...
                            <div class="option-item">
                                @if (Auth::user())
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <a href="route('logout')" onclick="event.preventDefault(); this.closest('form').submit();" class="bd-btn">تسجيل الخروج</a>
                                    </form>
                                @else
                                <a href="{{ route('login') }}" class="bd-btn" style="margin-top: 10px; margin-left: 20px;">تسجيل الدخول</a>
                                @endif
                            </div>
                        </div>
   ...
   <main>
      ...
      <section class="bd-hero-area bd-hero-area-3 fix">
            ...
            <div class="bd-hero-inner-3">
               <div class="bd-hero-shape-wrapper d-none d-lg-block">
                  <div class="bd-hero-3-shape-2">
                     <img src="assetss/img/shape/curved-line-2.png" alt="Shape not found">
                  </div>
               </div>
               <div class="row align-items-center">
                  <div class="col-lg-7 col-md-6">
                     <div class="bd-hero-content">
                        <span class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">Kindergarten
                           Program</span>
                        ...
                        <div class="bd-hero-thumb-3-wrapper p-relative z-index-1" data-depth=".4">
                           <div class="bd-hero-thumb-3 p-relative">
                              <div class="bd-hero-thumb-3-mask">
                                 <img src="assetss/img/hero/hero-3.jpg" alt="img not found!">
                              </div>
                           </div>
                           <div class="bd-hero-thumb-3-shape d-none d-md-block">
                              <div class="bd-hero-thumb-3-shape-1 p-absolute">
                                 <img src="assetss/img/shape/home-3-shape-1.png" alt="img not found!">
                              </div>
                              <div class="bd-hero-thumb-3-shape-2 p-absolute">
                                 <img src="assetss/img/shape/home-3-shape-2.png" alt="img not found!">
                              </div>
                              <div class="bd-hero-thumb-3-shape-3 p-absolute">
                                 <img src="assetss/img/shape/home-3-shape-3.png" alt="img not found!">
                              </div>
                           </div>
                        </div>
                     </div>
         ...
         <div class="bd-hero-3-shape d-none d-lg-block" id="scene2">
            <img data-depth=".5" src="assetss/img/shape/hero-3-shape-4.png" alt="img not found!">
         </div>
      </section>
      <!-- hero area end here  -->
                        ...
                        <div class="swiper-slide">
                           <div class="bd-class-wrapper text-center">
                              ...
                              <div class="bd-class-bg">
                                 <img src="assetss/img/bg/bg-shape.jpg" alt="img not found!">
                              </div>
                              <div class="bd-class">
                                 ...
                                 <div class="bd-class-content">
                                    <h3 class="bd-class-title"><a href="class-details.html">Sports Class</a></h3>
                                    <p>Each day at Mother’s Pride is a cele bration! We celebrate all.</p>
                        ...
                        <div class="swiper-slide">
                           <div class="bd-class-wrapper text-center">
                              ...
                              <div class="bd-class text-center">
                                 ...
                                 <div class="bd-class-content">
                                    <h3 class="bd-class-title"><a href="class-details.html">Drowing Class</a></h3>
                                    <p>Our special rhyme books also them to phonetic sound of the words.</p>
                                    <div class="bd-class-btn">
                                       <a href="class-details.html" class="bd-btn bd-btn-grey">
                                          <span class="bd-btn-inner">
                                             <span class="bd-btn-normal">View Details</span>
                  ...
                  <div class="bd-promotion-thumb-wrapper mb-60 wow fadeInLeft" data-wow-duration="1s"
                     ...
                     <div class="bd-promotion-thumb">
                        <div class="bd-promotion-thumb-mask p-relative wow fadeInLeft" data-wow-duration="1s"
                           data-wow-delay=".3s">
                           <img src="assetss/img/promotion/1.png" alt="Image not found">
                           <div class="panel wow"></div>
                        </div>
                     </div>
                     <div class="bd-promotion-shape d-none d-lg-block">
                        <img src="assetss/img/shape/tripple-line.png" alt="Shape not found">
                     </div>
                  </div>
               </div>
               <div class="col-xl-6 col-lg-6">
                              ...
                              <div class="bd-program-thumb-wrapper">
                                 <a href="program-details.html">
                                    <div class="bd-program-thumb">
                                       <img src="assetss/img/program/home-program-1.jpg" alt="Image not found">
                                    </div>
                                 </a>
                        ...
                        <div class="swiper-slide">
                           <div class="bd-program">
                              <div class="bd-program-thumb-wrapper">
                                 <a href="program-details.html">
                                    <div class="bd-program-thumb">
                                       <img src="assetss/img/program/home-program-2.jpg" alt="Image not found">
                                    </div>
                                 </a>
                                 <div class="bd-program-shape">
                        ...
                        <div class="swiper-slide">
                           <div class="bd-program">
                              <div class="bd-program-thumb-wrapper">
                                 <a href="program-details.html">
                                    <div class="bd-program-thumb">
                                       <img src="assetss/img/program/home-program-3.jpg" alt="Image not found">
                                    </div>
                                 </a>
                                 <div class="bd-program-shape">
                  ...
                  <div class="bd-faq-thumb-wrapper mb-70 wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">
                     <div class="bd-faq-thumb">
                        <div class="bd-faq-thumb-mask p-relative wow fadeInRight" data-wow-duration="1s"
                           data-wow-delay=".3s">
                           <img src="assetss/img/faq/1.jpg" alt="Image not found">
      ...
      <section class="bd-joining-area pt-100 pb-100">
         <!-- joiniong bg -->
         <div class="bd-joining-bg" data-background="assetss/img/bg/joining-area.png"></div>
         <!-- joining bg overlay -->
            ...
            <div class="bd-joining">
               <div class="bd-joining-shape-wrapper d-none d-md-block">
                  <div class="bd-joining-shape-1 p-absolute">
                     <img src="assetss/img/shape/white-curved-line.png" alt="img not found!">
                  </div>
      ...
      <section class="bd-teacher-area pt-120 pb-120">
         <div class="container">
            ...
            <div class="row">
               <div class="col-12">
                  <div class="bd-teacher-active swiper-container wow fadeInLeft" data-wow-duration="1s"
                     data-wow-delay=".4s">
                     <div class="swiper-wrapper">
                        <div class="swiper-slide">
                           <div class="bd-teacher">
                              <a href="teacher-details.html">
                                 <div class="bd-teacher-thumb">
                                    <img src="assetss/img/teacher/5.jpg" alt="Image not found">
                                 </div>
                              </a>
                        ...
                        <div class="swiper-slide">
                           <div class="bd-teacher">
                              <a href="teacher-details.html">
                                 <div class="bd-teacher-thumb">
                                    <img src="assetss/img/teacher/3.jpg" alt="Image not found">
                                 </div>
                              </a>
                              <div class="bd-teacher-content-wrapper">
                                 <div class="bd-teacher-content">
                        ...
                        <div class="swiper-slide">
                           <div class="bd-teacher">
                              <a href="teacher-details.html">
                                 <div class="bd-teacher-thumb">
                                    <img src="assetss/img/teacher/7.jpg" alt="Image not found">
                                 </div>
                              </a>
                              <div class="bd-teacher-content-wrapper">
                                 <div class="bd-teacher-content">
                        ...
                        <div class="swiper-slide">
                           <div class="bd-teacher">
                              <a href="teacher-details.html">
                                 <div class="bd-teacher-thumb">
                                    <img src="assetss/img/teacher/2.jpg" alt="Image not found">
                                 </div>
                              </a>
                              <div class="bd-teacher-content-wrapper">
                                 <div class="bd-teacher-content">
      ...
      <section class="bd-testimonial-area theme-bg">
         <div class="bd-testimonial-video" data-background="assetss/img/bg/testimonail-bg.png">
         ...
         <div class="bd-testimonial-bg d-none d-lg-block" data-background="assetss/img/bg/bg-shape.jpg"></div>
         <div class="container">
                        ...
                        <div class="swiper-wrapper">
                              ...
                              <div class="bd-testimonial">
                                 ...
                                 <div class="bd-testimonial-avatar d-flex align-items-center">
                                    <div class="bd-testimonial-avatar-thumb">
                                       <img src="assetss/img/testimonials/1.png" alt="testimonial avatar">
                                    </div>
                           ...
                           <div class="swiper-slide">
                              <div class="bd-testimonial">
                                 ...
                                 <div class="bd-testimonial-avatar d-flex align-items-center">
                                    <div class="bd-testimonial-avatar-thumb">
                                       <img src="assetss/img/testimonials/3.png" alt="testimonial avatar">
                                    </div>
                           ...
                           <div class="swiper-slide">
                              <div class="bd-testimonial">
                                 ...
                                 <div class="bd-testimonial-avatar d-flex align-items-center">
                                    <div class="bd-testimonial-avatar-thumb">
                                       <img src="assetss/img/testimonials/2.png" alt="testimonial avatar">
                                    </div>
                     ...
                     <div class="swiper-wrapper">
                           ...
                           <div class="bd-blog">
                              <a href="news-details.html">
                                 <div class="bd-blog-thumb">
                                    <img src="assetss/img/blog/2.jpg" alt="blog image">
                                 </div>
                              </a>
                        ...
                        <div class="swiper-slide">
                           <div class="bd-blog">
                              <a href="news-details.html">
                                 <div class="bd-blog-thumb">
                                    <img src="assetss/img/blog/3.jpg" alt="blog image">
                                 </div>
                              </a>
                              <div class="bd-blog-content">
                                 <div class="bd-blog-date">
      ...
      <section class="bd-newsletter-area">
         <div class="container">
            <div class="bd-newsletter pt-100 pb-100 theme-bg">
               <div class="bd-newsletter-bg" data-background="assetss/img/bg/newsletter-bg.jpg"></div>
               <div class="row justify-content-center">
      ...
      <div class="bd-footer-area pt-200">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                     <div class="bd-footer-widget bd-footer-widget-1 mb-50">
                        <div class="bd-footer-logo mb-35">
                           <a href="index.html"> <img src="assetss/img/logo/logo.svg" alt="img not found!"></a>
                        </div>
         ...
         <div class="bd-footer-copyright pb-5">
            <div class="bd-footer-copyright-line pb-20">
               <img src="assetss/img/shape/wave-line.png" alt="bottom line">
            </div>
            <div class="container">
   ...
   <!-- JS here -->
   <script src="assetss/js/vendor/jquery.js"></script>
   <script src="assetss/js/vendor/waypoints.js"></script>
   <script src="assetss/js/bootstrap-bundle.js"></script>
   <script src="assetss/js/meanmenu.js"></script>
   <script src="assetss/js/swiper-bundle.js"></script>
   <script src="assetss/js/slick.js"></script>
   <script src="assetss/js/nouislider.js"></script>
   <script src="assetss/js/magnific-popup.js"></script>
   <script src="assetss/js/parallax.js"></script>
   <script src="assetss/js/backtotop.js"></script>
   <script src="assetss/js/nice-select.js"></script>
   <script src="assetss/js/wow.min.js"></script>
   <script src="assetss/js/isotope-pkgd.js"></script>
   <script src="assetss/js/imagesloaded-pkgd.js"></script>
   <script src="assetss/js/ajax-form.js"></script>
   <script src="assetss/js/jquery.appear.js"></script>
   <script src="assetss/js/jquery.odometer.min.js"></script>
