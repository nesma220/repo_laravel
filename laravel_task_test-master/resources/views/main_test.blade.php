                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">عرض الكتب</h3>
                            </div>
                        </div>
                        <div class="card-body">
                            <!--begin::Example-->
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{asset('storage/'.$post->post_img)}}" target="_blank"><img src="{{asset('storage/'.$post->post_img)}}"  style="width: 70px; heigh :70px; "></a></td>
                                            ...
                                            <a style="margin-right: 45px; margin-top: -52px;" href="{{ route('posts.edit', $post->id) }}" class="btn btn-icon btn-primary btn-circle mr-2">
